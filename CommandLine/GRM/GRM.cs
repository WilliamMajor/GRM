...
namespace GRM
{
    ...
    class GRM
    {
        ...
        static string connectedReaderMAC = " ";
        ...
        {
            string userControl = " ";
            while(readerCount < 1) // Wait for there to be a reader recognized by the program
            {
                Thread.Sleep(100);
            }
            connectReader();
            ...
            while(!programEnding)
            {
                ...
                userControl = Console.ReadLine();
                userControl = userControl.ToUpper();
                if(userControl == "Q")
                {
